...
import styles from "./CreateArticleCourse.module.css";
import "../../asserts/styles/reactQuill.css";

const CreateArticleCourseView = ({ textEditor, setTextEditor, handleSubmit }) => {
  const modules = {
    toolbar: [
      [{ header: [1, 2, 3, false] }],
...
export default CreateArticleCourseView;
