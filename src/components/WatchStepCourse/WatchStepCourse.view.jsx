...
import style from "./WatchStepCourse.module.css";
...
const WatchStepCourseView = ({
  ...
  const handleStepClick = (index) => {
    ...
    getVideo(userAudioTourStepsListQuery.data[index].id);
  };
...
export default WatchStepCourseView;
